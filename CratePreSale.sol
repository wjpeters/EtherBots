...
contract CratePreSale is Ownable {
    ...
    uint256 constant public PRESALE_END_TIMESTAMP = 1518181200; // End date for the presale - no purchases can be made after this date - Midnight 10 Feb 2018 UTC
    ...
    function getMyRobots() view public returns (uint[]) {
        return userToRobots[msg.sender];
    }
